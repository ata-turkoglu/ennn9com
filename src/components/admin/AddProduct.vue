      ...
      <form id="form" @submit.prevent>
        ...
        <div class="form-group">
          ...
          <select
            id="cat1"
            @change="onCat1Change()"
            v-model="$v.product.category1.$model"
          >
        ...
        <div class="form-group">
          ...
          <input
            id="videolink"
            type="text"
            v-model="$v.product.videolink.$model"
          />
        </div>
        <div class="form-group">
          ...
          <textarea
            id="specs"
            :onkeyup="autoGrow('specs')"
            v-model="$v.product.specs.$model"
          ></textarea>
        </div>
        <div class="form-group">
          ...
          <textarea
            id="diff"
            :onkeyup="autoGrow('diff')"
            v-model="$v.product.differences.$model"
          ></textarea>
        </div>
        <div class="form-group">
