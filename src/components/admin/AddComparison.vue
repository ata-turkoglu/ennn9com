    ...
    <div id="head-text">
      <div id="head">
        ...
        <div class="buttons">
          ...
          <button style="background-color:lightblue" @click="save">
            Kaydet
          </button>
        </div>
      </div>
    ...
    <div id="container" v-if="products.length>0">
      <div class="product" v-for="(product,index) in products" :key="index">
        ...
        <div class="differences">
          ...
          <p class="diff-item" v-for="(spec,indx) in product.specs" :key="indx">
            {{spec}}
          </p>
        </div>
        <div class="pvideo">
...
.buttons button {
  ...
  width: 10vmax;
  margin-left: 3vmax;
  margin-block: 0.3vmax;
  border-radius: 0.5vmax;
  border: none;
  cursor: pointer;
  box-shadow: 0 0 0.8vmax -0.3vmax grey;
...
.product {
  ...
  border-radius: 0.5vmax;
  box-shadow: 0 0 1vmax -0.5vmax grey;
}
.des {
  display: flex;
  flex-direction: column;
...
.des button {
  ...
  box-shadow: 0 0 0.7vmax -0.2vmax grey;
  cursor: pointer;
}
.des button:hover {
  box-shadow: none;
