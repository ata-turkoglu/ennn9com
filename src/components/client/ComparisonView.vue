    ...
    >
      ...
      >
        ...
        <div class="differences">
          ...
          <p class="diff-item" v-for="(spec,ind) in product.specs" :key="ind">
            {{spec}}
          </p>
        </div>
        <div class="differences">
          ...
          <p
            class="diff-item"
            v-for="(diff,ind) in product.differences"
            :key="ind"
          >
            {{diff}}
          </p>
        ...
        <div class="pvideo">
          <img
            v-if="product.videolink==''"
            src="../../assets/items/youtube.png"
            @click="toVideo"
          />
          <iframe
            v-if="product.videolink!=null"
            @focus="focusframe($event)"
