    ...
    <div class="section" v-for="(item,index) in getComparisons" :key="index">
      ...
      <div class="container">
        <div class="nav" style="left:0">
          <img
            class="arrow"
            src="../../assets/items/left-arrow.png"
            @click="left($event,index)"
          />
        </div>
        ...
        <div class="nav" style="right:0">
          <img
            class="arrow"
            src="../../assets/items/right-arrow.png"
            @click="right($event,index)"
          />
        </div>
      </div>
    </div>
...
.header {
  ...
  font-size: 2.5vh;
  font-weight: 700;
  filter: drop-shadow(0 0 0.8vmax rgb(10, 10, 10, 0.4));
}
.section hr {
  width: 50%;
  margin-right: 0;
...
.item:hover {
  ...
  box-shadow: 0 0 0.5vmax -0.2vmax rgb(0, 153, 204);
...
.item-image img {
  ...
  margin: 0;
  object-fit: cover;
  border-bottom: 0.3vmax solid lightblue;
  box-sizing: border-box;
}
.text {
  display: flex;
