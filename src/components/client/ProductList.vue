  ...
  <div id="list">
    <div id="nav">
      <div class="filter">
        ...
        >
          ...
          <p
            @click="filter1(null), isCat=0"
            class="filter1-p"
            :class="{'border1':isCat==0}"
          >
            Tümü
          </p>
          <p
            @click="filter1('Hamilelik'), isCat=1"
            class="filter1-p"
            tabindex="1"
            :class="{'border1':isCat==1}"
          >
            Hamilelik
          </p>
          <p
            @click="filter1('Bebek'), isCat=2"
            class="filter1-p"
            tabindex="2"
            :class="{'border1':isCat==2}"
          >
            Bebek
          </p>
          <p
            @click="filter1('Çocuk'), isCat=3"
            class="filter1-p"
            tabindex="3"
            :class="{'border1':isCat==3}"
          >
            Çocuk
          </p>
          <p
            @click="filter1('Moda'), isCat=4"
            class="filter1-p"
            tabindex="4"
            :class="{'border1':isCat==4}"
          >
            Moda
          </p>
          <p
            @click="filter1('Kozmetik'), isCat=5"
            class="filter1-p"
            tabindex="5"
            :class="{'border1':isCat==5}"
          >
            Kozmetik
          </p>
          <p
            @click="filter1('Diğer'), isCat=6"
            class="filter1-p"
            tabindex="6"
            :class="{'border1':isCat==6}"
          >
            Diğer
          </p>
        </div>
      ...
      <div class="filter" style="margin-top:1.5vh">
        ...
        >
          <p
            ...
            :key="index"
            @click="filter2(item),isSub=index"
            :tabindex="index"
            class="filter2-p"
            :class="{'border2':isSub==index}"
          >
            {{item}}
          </p>
        </div>
    ...
    <div class="container">
      <div class="product" v-for="(item,index) in getProducts" :key="index">
        ...
        <div class="content">
          <p class="text3" v-for="(spec,indx) in item.specs" :key="indx">
            {{spec}}
          </p>
        </div>
        <div class="brand">
